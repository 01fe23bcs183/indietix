        ...
        {showDebug && event.scoreComponents && (
          <div className="mt-3 pt-3 border-t border-gray-200 text-xs text-gray-500">
            ...
            <div className="grid grid-cols-2 gap-1">
              ...
              <span>
                Trigram: {event.scoreComponents.trigramSimilarity.toFixed(3)}
              </span>
              <span>
                Recency: {event.scoreComponents.recencyBoost.toFixed(3)}
              </span>
              {event.scoreComponents.embeddingSimilarity !== undefined && (
                <span>
                  Embed: {event.scoreComponents.embeddingSimilarity.toFixed(3)}
                </span>
              )}
            </div>
          </div>
