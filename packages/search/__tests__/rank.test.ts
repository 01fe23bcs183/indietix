...
describe('reRankWithEmbeddings', () => {
  it('should re-rank results by combined score', () => {
    const results = [
      { id: '1', ftsRank: 0.9, trigramSimilarity: 0.8, recencyBoost: 0.5, embedding: [1, 0, 0] },
      { id: '2', ftsRank: 0.7, trigramSimilarity: 0.6, recencyBoost: 0.9, embedding: [0, 1, 0] },
      { id: '3', ftsRank: 0.5, trigramSimilarity: 0.4, recencyBoost: 0.7, embedding: [0.7, 0.7, 0] },
    ];
